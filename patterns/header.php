...
<div class="wp-block-buttons"><!-- wp:button {"style":{"typography":{"fontSize":"12px"},"spacing":{"padding":{"top":"0.88rem","bottom":"0.88rem","left":"2.69rem","right":"2.69rem"}}}} -->
<div class="wp-block-button has-custom-font-size" style="font-size:12px"><a class="wp-block-button__link wp-element-button" style="padding-top:0.88rem;padding-right:2.69rem;padding-bottom:0.88rem;padding-left:2.69rem"><strong>Log in</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
